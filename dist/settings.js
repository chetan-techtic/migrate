...
async function parseSettings(settings, requireShadow = false) {
    ...
    const validateAction = actions_1.makeValidateActionCallback();
    ...
    return Object.assign(Object.assign({}, settings), { afterReset: afterReset, afterAllMigrations: afterAllMigrations, afterCurrent: afterCurrent, rootConnectionString: rootConnectionString, connectionString: connectionString, manageGraphileMigrateSchema: manageGraphileMigrateSchema, databaseOwner: databaseOwner, migrationsFolder, databaseName: databaseName, shadowConnectionString: shadowConnectionString
            ? shadowConnectionString
